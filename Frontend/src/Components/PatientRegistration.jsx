...
const PatientRegistrationForm = () => {
  ...
  const sendOTP = async () => {
    try {
      const response = await axios.post(
        "https://swathya-sanjivani-fqjhn6vge-kavya-patels-projects.vercel.app/send-otp",
  ...
  const verifyOTP = async () => {
    try {
      const response = await axios.post(
        "https://swathya-sanjivani-fqjhn6vge-kavya-patels-projects.vercel.app/patient/verify-otp",
        { mobile, otp }
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://swathya-sanjivani-fqjhn6vge-kavya-patels-projects.vercel.app/patient/register",
