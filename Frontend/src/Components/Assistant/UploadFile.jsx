...
const UploadFile = () => {
  return (
    <div className="bg-white p-4 rounded-lg shadow-sm mb-6">
      <h2 className="text-[#0e606e] font-medium text-lg mb-4">Upload New Files For Sanjaybhai</h2>
      <div className="border-2 border-dashed border-gray-300 rounded-md p-8 flex flex-col items-center justify-center">
        ...
        <button className="bg-[#0e606e] text-white px-4 py-2 rounded-md">Select Files</button>
      </div>
    </div>
  );
};
