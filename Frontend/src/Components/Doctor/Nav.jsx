        ...
        <nav className="bg-white shadow z-50 relative py-2 mb-1">
                ...
                <div className="flex justify-between h-16">
                    ...
                    <div className="flex items-center">
                        <div className="flex space-x-4 lg:space-x-8">
                            ...
                            <NavLink to="/DoctorFamily" className={navLinkClasses}>
                                Family
                            </NavLink>
                            <NavLink to="/allDoctor" className={navLinkClasses}>
                                Doctor
                            </NavLink>
            ...
            <div className="hidden">
                <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                    <NavLink to="/Dashbord" className={navLinkClasses}>Home</NavLink>
                    <NavLink to="/DoctorFamily" className={navLinkClasses}>Family</NavLink>
                    <NavLink to="/allDoctor" className={navLinkClasses}>Doctor</NavLink>
                    <NavLink to="/Guide" className={navLinkClasses}>Guide</NavLink>
                    <button
                        onClick={handleLogout}
