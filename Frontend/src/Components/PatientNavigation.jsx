                ...
                <div className="flex justify-between h-16">
                    ...
                    <div className="flex items-center">
                        <div className="flex space-x-4 lg:space-x-8">
                            <Link to="/PatientDashboard" className={`border-b-2 px-1 inline-flex items-center text-md font-medium ${isActive("/PatientDashboard")}`}>
                                Home
                            </Link>
                            <Link to="/PatientFamilyPage" className={`border-b-2 px-1 inline-flex items-center text-md font-medium ${isActive("/PatientFamilyPage")}`}>
                                Family
                            </Link>
                            ...
                            <Link to="/PatientGuide" className={`border-b-2 px-1 inline-flex items-center text-md font-medium ${isActive("/PatientGuide")}`}>
                                Guide
                            </Link>
                        </div>
                    </div>
            ...
            {isMenuOpen && (
                <div className="md:hidden">
                    <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                        <Link to="/PatientDashboard" className={`block px-3 py-2 rounded-md text-base font-medium ${isActive("/PatientDashboard")} hover:bg-gray-50`}>
                            Home
                        </Link>
                        ...
                        <Link to="/PatientGuide" className={`block px-3 py-2 rounded-md text-base font-medium ${isActive("/PatientGuide")} hover:bg-gray-50`}>
                            Guide
                        </Link>
